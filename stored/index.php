    ...
    <div class="login-root">
        ...
        <div class="formbg-outer">
            ...
            <div class="formbg-inner padding-horizontal--48">
                <span class="padding-bottom--15">register in to your account</span>
                ...
                <div class="field">
                    <a class="ssolink" style="padding:0 0 20px 0;" href="login.php">Log in </a>
                </div>
                </form>
                    <?php
                    include("namedb.php");        
                            ...
                            if($checkEmail->rowCount()>0){
                                ...
                                if($password1 == $password2){
                                    $password1 = sha1($password1);
                                        ...
                                        $adddb = $db->prepare("INSERT INTO users(username,email,password)
                                        VALUES (:username, :email, :password)");
                                        
                                        $adddb->bindParam("username", $name);
                                        $adddb->bindParam("email", $emails);
