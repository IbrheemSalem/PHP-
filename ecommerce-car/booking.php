...
if(isset($_POST['submit'])){
    ...
    try {
        $sql = "INSERT INTO catalog(name_book, email_book, subject_book, data_send)
        VALUES ('$name', '$email', '$catalog', '$date')";
        $conn->exec($sql);
            $condition= "<div class='alert alert-success mt-3' role='alert'>successfully</div>";    
    } catch(PDOException $e) {
            $condition= "<div class='alert alert-danger mt-3' role='alert'>Danger</div";
    }
    $conn = null;
}
?>
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-6">
                    <div class="bg-primary h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                        <h1 class="text-white mb-4">Request For a Catalog</h1>
                        <form action="" method="POST">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control border-0" name="catalog" placeholder="Name Catalog"></textarea>
                                </div>
                                <div class="col-12">
