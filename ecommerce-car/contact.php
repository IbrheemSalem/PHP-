...
if(isset($_POST['submit'])){
    ...
    try {
        $sql =("INSERT INTO contact (name_con, email_con, subject_con , message_con)
        VALUES ('$_POST[name]', '$_POST[email]', '$_POST[subject]', '$_POST[message]')");
        $conn->exec($sql);
        $condition = "<div class='alert alert-success mt-3' role='alert'>success</div>";
    } catch(PDOException $e) {
        $condition = "<div class='alert alert-danger mt-3' role='alert'>Error</div>";
    }
    $connp = null;
}
?>
